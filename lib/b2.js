...
function B2(options) {
    ...
    /*
        ...
        sets maxRedirects to 0 since the B2 API never redirects, and the default causes in-memory buffering of all requests that is pointless for B2 requests
    */
    const axiosClient = axios.create(Object.assign({ maxRedirects: 0 }, options.axios));
    /*
